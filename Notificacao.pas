...
class procedure TLoadingToast.Hide;
begin
...
class procedure TLoadingToast.Show(const Frm : Tform; const msg: string);
var
...
class procedure TLoadingToast.DeleteToast(Sender: TObject);
begin
...
class procedure TLoadingToast.ToastMessage(const Frm : Tform; const msg: string;
                                      alinhamento: TAlignLayout = TAlignLayout.Bottom;
                                      cor_fundo: Cardinal = $FF22AF70;
                                      cor_fonte: Cardinal = $FFFFFFFF;
                                      duracao: integer = 4);
...
begin
        ...
        AnimacaoToast.OnFinish := TLoadingToast.DeleteToast;
